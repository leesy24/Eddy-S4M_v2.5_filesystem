	...
	IN	PUCHAR			arg)
{
	...
	{						
		...
		RTMPCancelTimer(&pAd->Mlme.PeriodicTimer, &TimerCancelled);
    ...
    IN  PRTMP_ADAPTER   pAd)
{
	...
	pAd->Mlme.PeriodicTimer.TimerObj.expires = jiffies + MLME_TASK_EXEC_INTV;
	add_timer(&pAd->Mlme.PeriodicTimer.TimerObj);

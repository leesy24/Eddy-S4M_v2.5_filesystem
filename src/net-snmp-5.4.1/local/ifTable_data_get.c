...
ifTable_indexes_set(ifTable_rowreq_ctx *rowreq_ctx, long ifIndex_val)
{
    ...
    if(MFD_SUCCESS != ifTable_indexes_set_tbl_idx(&rowreq_ctx->tbl_idx
                                   , ifIndex_val
           ))
        return MFD_ERROR;
 ...
 */
int
ifDescr_get( ifTable_rowreq_ctx *rowreq_ctx, char **ifDescr_val_ptr_ptr, size_t *ifDescr_val_ptr_len_ptr )
{
   /** we should have a non-NULL pointer and enough storage */
   netsnmp_assert( (NULL != ifDescr_val_ptr_ptr) && (NULL != *ifDescr_val_ptr_ptr));
 ...
 */
    ...
    if ((NULL == (* ifDescr_val_ptr_ptr )) ||
         ...
         */
        (* ifDescr_val_ptr_ptr ) = malloc(rowreq_ctx->data.ifDescr_len* sizeof(rowreq_ctx->data.ifDescr[0]));
        if(NULL == (* ifDescr_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory\n");
            return MFD_ERROR;
        }
    }
    (* ifDescr_val_ptr_len_ptr ) = rowreq_ctx->data.ifDescr_len* sizeof(rowreq_ctx->data.ifDescr[0]);
    memcpy( (* ifDescr_val_ptr_ptr ), rowreq_ctx->data.ifDescr, rowreq_ctx->data.ifDescr_len* sizeof(rowreq_ctx->data.ifDescr[0]) );
 ...
 */
int
ifPhysAddress_get( ifTable_rowreq_ctx *rowreq_ctx, char **ifPhysAddress_val_ptr_ptr, size_t *ifPhysAddress_val_ptr_len_ptr )
{
   /** we should have a non-NULL pointer and enough storage */
   netsnmp_assert( (NULL != ifPhysAddress_val_ptr_ptr) && (NULL != *ifPhysAddress_val_ptr_ptr));
 ...
 */
    ...
    if ((NULL == (* ifPhysAddress_val_ptr_ptr )) ||
        ((* ifPhysAddress_val_ptr_len_ptr ) <
         (rowreq_ctx->data.ifPhysAddress_len* sizeof(rowreq_ctx->data.ifPhysAddress[0])))) {
        /*
         * allocate space for ifPhysAddress data
         */
        (* ifPhysAddress_val_ptr_ptr ) = malloc(rowreq_ctx->data.ifPhysAddress_len* sizeof(rowreq_ctx->data.ifPhysAddress[0]));
        if(NULL == (* ifPhysAddress_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory\n");
            return MFD_ERROR;
        }
    ...
    memcpy( (* ifPhysAddress_val_ptr_ptr ), rowreq_ctx->data.ifPhysAddress, rowreq_ctx->data.ifPhysAddress_len* sizeof(rowreq_ctx->data.ifPhysAddress[0]) );
 ...
 */
int
ifAdminStatus_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifAdminStatus_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifOperStatus_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifOperStatus_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifLastChange_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifLastChange_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifInOctets_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifInOctets_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifInUcastPkts_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifInUcastPkts_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifInNUcastPkts_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifInNUcastPkts_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifInDiscards_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifInDiscards_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifInErrors_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifInErrors_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifInUnknownProtos_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifInUnknownProtos_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifOutOctets_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifOutOctets_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifOutUcastPkts_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifOutUcastPkts_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifOutNUcastPkts_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifOutNUcastPkts_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifOutDiscards_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifOutDiscards_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifOutErrors_get( ifTable_rowreq_ctx *rowreq_ctx, u_long * ifOutErrors_val_ptr )
{
   /** we should have a non-NULL pointer */
 ...
 */
int
ifSpecific_get( ifTable_rowreq_ctx *rowreq_ctx, oid **ifSpecific_val_ptr_ptr, size_t *ifSpecific_val_ptr_len_ptr )
{
   /** we should have a non-NULL pointer and enough storage */
   netsnmp_assert( (NULL != ifSpecific_val_ptr_ptr) && (NULL != *ifSpecific_val_ptr_ptr));
 ...
 */
    ...
    if ((NULL == (* ifSpecific_val_ptr_ptr )) ||
        ((* ifSpecific_val_ptr_len_ptr ) <
         (rowreq_ctx->data.ifSpecific_len* sizeof(rowreq_ctx->data.ifSpecific[0])))) {
        /*
         * allocate space for ifSpecific data
         */
        (* ifSpecific_val_ptr_ptr ) = malloc(rowreq_ctx->data.ifSpecific_len* sizeof(rowreq_ctx->data.ifSpecific[0]));
        if(NULL == (* ifSpecific_val_ptr_ptr )) {
            snmp_log(LOG_ERR,"could not allocate memory\n");
            return MFD_ERROR;
        }
    }
    (* ifSpecific_val_ptr_len_ptr ) = rowreq_ctx->data.ifSpecific_len* sizeof(rowreq_ctx->data.ifSpecific[0]);
    memcpy( (* ifSpecific_val_ptr_ptr ), rowreq_ctx->data.ifSpecific, rowreq_ctx->data.ifSpecific_len* sizeof(rowreq_ctx->data.ifSpecific[0]) );

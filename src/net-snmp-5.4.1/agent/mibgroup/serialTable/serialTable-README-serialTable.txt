...
------------------------------------------------------------------------
  ...
  the serialTable table.  The agent will start by looking for the right
  ...
  file defaults/table-serialTable.m2d, and then re-running mib2c.
 ...
 Index(es) for the serialTable table
  ------------------------------------------------------------
  The index(es) for the serialTable table are:
...
************************************************************************
serialTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the serialTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: serialTable_data_access.[c|h]
------------------------------------------------------------------------
  The serialTable_data_access file contains the interface to your data in
  ...
  FUNC : serialTable_indexes_set
  WHERE: serialTable_data_access.c
...
------------------------------------------------------------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : remoteIPAddress_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : remoteSocketNumber_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : bypassEnable_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : loginEnable_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : loginUsername_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : loginPassword_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : connectionCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : connectionStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : serialRowStatus_get



File: serialTable_data_set.c
------------------------------------------------------------------------
  ...
  Set $m2c_table_dependencies = 0 in defaults/table-serialTable.m2d
  ...
  FUNC : portIndex_check_index


  Validate index
  --------------
  TODO : check that all index components are valid
  FUNC : serialTable_validate_index
  ...
  ----------------------
  TODO : perform additional validations on values for a set request
  FUNC : serialRowStatus_check_value
  ...
  ---------------------
  TODO : save the value for column
  FUNC : serialRowStatus_undo_setup
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the serialTable table.

To watch the flow of the serialTable table, use the
following debug tokens:
        ...
        serialTable
        verbose:serialTable
        internal:serialTable

e.g.
        snmpd -f -Le -DserialTable,verbose:serialTable,internal:serialTable

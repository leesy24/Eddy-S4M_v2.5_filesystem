...
#define NETSNMP_DEFAULT_MIBS ":RS-232-MIB:SYSBAS-MIB:SNMPv2-MIB:RFC1213-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IF-MIB:IP-MIB:IP-FORWARD-MIB:TCP-MIB:UDP-MIB:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB"
...
#define NETSNMP_CONFIGURE_OPTIONS "'--host=arm-linux' '--target=arm-linux' '--with-endianness=little' '--disable-embedded-perl' '--enable-mini-agent' '--enable-shared=no' '--disable-debugging' '--disable-applications' '--disable-manuals' '--with-cflags=-I/home/WORK/eddy-21/filesystem_2.1.0.3/src/Eddy_APPs/include' '--with-mib-modules=rs232 sysbas mibII sendtrap' 'CC=/opt/lemonix/cdt/bin/arm-linux-gcc' 'host_alias=arm-linux' 'target_alias=arm-linux'"

...
/* Define if compiling with the rs232 module files.  */
#define USING_RS232_MODULE 1
 
/* Define if compiling with the sysbas module files.  */
#define USING_SYSBAS_MODULE 1
 
/* Define if compiling with the mibII module files.  */
#define USING_MIBII_MODULE 1
 
/* Define if compiling with the sendtrap module files.  */
#define USING_SENDTRAP_MODULE 1
 
/* Define if compiling with the default_modules module files.  */
#define USING_DEFAULT_MODULES_MODULE 1
 
/* Define if compiling with the rs232/rs232_access module files.  */
#define USING_RS232_RS232_ACCESS_MODULE 1
 
/* Define if compiling with the rs232/rs232_checkfns_local module files.  */
#define USING_RS232_RS232_CHECKFNS_LOCAL_MODULE 1
 
/* Define if compiling with the rs232/rs232_checkfns module files.  */
#define USING_RS232_RS232_CHECKFNS_MODULE 1
 
/* Define if compiling with the rs232/rs232 module files.  */
#define USING_RS232_RS232_MODULE 1
 
/* Define if compiling with the sysbas/sysbas_access module files.  */
#define USING_SYSBAS_SYSBAS_ACCESS_MODULE 1
 
/* Define if compiling with the sysbas/sysbas_checkfns_local module files.  */
#define USING_SYSBAS_SYSBAS_CHECKFNS_LOCAL_MODULE 1
 
/* Define if compiling with the sysbas/sysbas_checkfns module files.  */
#define USING_SYSBAS_SYSBAS_CHECKFNS_MODULE 1
 
/* Define if compiling with the sysbas/sysbas module files.  */
#define USING_SYSBAS_SYSBAS_MODULE 1
...
/* Define if compiling with the sendtrap/notification module files.  */
#define USING_SENDTRAP_NOTIFICATION_MODULE 1
